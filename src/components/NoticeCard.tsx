  ...
  if (size === "lg") {
    return (
      <Link
        ...
        className="group flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-200 border border-gray-100 h-[272px]"
      >
        ...
        <div className="p-4 flex-1 overflow-hidden">
          <h3 className="font-bold text-navy-900 text-base leading-snug group-hover:text-gold-600 transition-colors mb-1.5 line-clamp-2">
            {notice.title}
          </h3>
          {notice.summary && (
